...
Revision ID: c00b57daea0b
Revises: 
Create Date: 2022-09-22 18:05:30.331093
...
def upgrade():
    ...
    op.create_table('link_group_user',
    sa.Column('id', sqlmodel.sql.sqltypes.GUID(), nullable=False),
    ...
    op.create_index(op.f('ix_link_group_user_id'), 'link_group_user', ['id'], unique=False)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_link_group_user_id'), table_name='link_group_user')
    op.drop_table('link_group_user')
